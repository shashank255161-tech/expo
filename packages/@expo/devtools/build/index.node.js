...
var iconvLite = __nccwpck_require__(235);

// Expose to the world
module.exports.C = convert;
...
var Buffer = (__nccwpck_require__(965).Buffer);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(572) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(231) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(949) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(949).concat)(__nccwpck_require__(603)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(949).concat)(__nccwpck_require__(603)) },
        gb18030: function() { return __nccwpck_require__(302) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(923) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(517) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return (__nccwpck_require__(517).concat)(__nccwpck_require__(244)) },
        encodeSkipVals: [
...
var StringDecoder = (__nccwpck_require__(193).StringDecoder);
...
var bomHandling = __nccwpck_require__(267),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(406); // Lazy load all encoding definitions.
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __nccwpck_require__(274)(stream_module);
...
var stream_module;
try {
    stream_module = __nccwpck_require__(203);
} catch (e) {}
...
var whatwgUrl = _interopDefault(__nccwpck_require__(583));
...
let convert;
try {
	convert = (__nccwpck_require__(190)/* .convert */ .C);
} catch (e) {}
...
var punycode = __nccwpck_require__(876);
var mappingTable = __nccwpck_require__(145);
...
const usm = __nccwpck_require__(30);
...
const conversions = __nccwpck_require__(186);
const utils = __nccwpck_require__(66);
const Impl = __nccwpck_require__(457);
...
exports.URL = __nccwpck_require__(662)["interface"];
exports.serializeURL = __nccwpck_require__(30).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(30).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(30).basicURLParse;
exports.setTheUsername = __nccwpck_require__(30).setTheUsername;
exports.setThePassword = __nccwpck_require__(30).setThePassword;
exports.serializeHost = __nccwpck_require__(30).serializeHost;
exports.serializeInteger = __nccwpck_require__(30).serializeInteger;
exports.parseURL = __nccwpck_require__(30).parseURL;
...
const punycode = __nccwpck_require__(876);
const tr46 = __nccwpck_require__(575);
